...
export const REQUIERMENTS_ID = {
	...
	GAME_REQ: "GAME_REQ",
	TODO_REQ: "TODO_REQ",
	PRESENTATION_REQ: "PRESENTATION_REQ",
};

// URL for datafiles for each set of requierment
export const REQUIERMENTS_URLS = {
	GENERIC_REQ: "data/genreq.json",
	GAME_REQ: "data/game.json",
	TODO_REQ: "data/todo.json",
	PRESENTATION_REQ: "data/presentation.json",
};
